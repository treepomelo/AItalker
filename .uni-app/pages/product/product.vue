...
const scenarios=['文化赏析','设计解读','门店导览'],tones=['古风雅叙','自然亲切','简洁专业'],durations=[30,60,90,120];
...
<style scoped>
.explanation{margin-top:24rpx;padding:24rpx 28rpx 32rpx;border:1rpx solid #e7dcc8;border-radius:12rpx;background:linear-gradient(135deg,#fbf7ee,#f6eddc)}
.explanation .script{display:block;font-family:'Kaiti SC','STKaiti','KaiTi','楷体','Songti SC','SimSun',serif;font-size:32rpx;line-height:2.1;letter-spacing:1rpx;color:#3e342e;overflow-wrap:break-word}
.explanation .sources{padding-top:20rpx;border-top:1rpx solid #e7dcc8;line-height:1.8}
