...
async function selectProduct(p){
  const current=++epoch;cancelPolling();stopAudio();selected.value=p;documents.value=[];history.value=[];explanation.value=null;audioUrl.value='';openedDoc.value='';generationError.value='';speechError.value='';loading.value=false;
...
function cleanup(){epoch++;loading.value=false;cancelPolling();stopAudio()}
