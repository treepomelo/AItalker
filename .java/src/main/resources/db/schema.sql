...
CREATE TABLE IF NOT EXISTS product_profile (product_id bigint PRIMARY KEY, details json NOT NULL);
CREATE TABLE IF NOT EXISTS explanation_detail (seq bigint AUTO_INCREMENT PRIMARY KEY, explanation_id varchar(64) NOT NULL UNIQUE, is_demo boolean NOT NULL DEFAULT false, scenario varchar(40), tone varchar(40), duration_seconds int, sources json NOT NULL);
CREATE TABLE IF NOT EXISTS speech_task_options (task_id varchar(64) PRIMARY KEY, product_id bigint NOT NULL, cache_key char(64) NOT NULL UNIQUE);
